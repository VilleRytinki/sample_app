...
I was really surprised about the efficiency of Rails. I got a functional pipeline from day 1 with very little or minimal configuration. Anything can be
modified if needed but getting a fully working pipeline with efficient testing is phenominal. I can imagine experienced developers creating production apps
in practically fraction of the time compared to other frameworks.
